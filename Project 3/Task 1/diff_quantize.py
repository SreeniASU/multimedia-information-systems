...
def createHistogram(histDict, m):
    '''
...
def writeToFile(videoName, outputString, n, access_type):
    '''
    writes the string "outputString" information to a file
    'n' argument is the n supplied by the user
    'access_type' defines if the function uses write mode or append mode
    if 'access_type' is 0, write mode is used. If 'type' is 1, append mode is used.
